...
def parse(locality, checkin_date, checkout_date, sort):
    ...
    headers = {
        ...
        'X-puid': 'WvPSNQoQMWYAACU@TskAAACP',
        'X-Requested-With': 'XMLHttpRequest'
    }
    # cookies = {"SetCurrency": "USD"}
    print("Downloading search results page")
    page_response = requests.post(url="https://www.tripadvisor.com/Hotels", data=form_data, headers=headers,
                                  verify=False).text
